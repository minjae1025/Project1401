...
public class StartMenuPanel extends JPanel {
	...
	public StartMenuPanel(StartMenuFrame frame, String id) {
		...
		JPanel PanelBlackLine = new JPanel();
		PanelBlackLine.setBackground(new Color(0, 0, 0));
		PanelBlackLine.setBounds(1, 99, 800, 2);
		add(PanelBlackLine);
		PanelBlackLine.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
