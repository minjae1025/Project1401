...
public class MainPanel extends JPanel {
	...
	public MainPanel(Main mainFrame) {
		...
		LogoTextPanel.setBounds(0, 0, 440, 85);
		add(LogoTextPanel);
		...
		lblNewLabel.setBounds(10, 25, 175, 18);
		Fotter.add(lblNewLabel);
		setLayout(null);
		
		JPanel MainPenal = new JPanel();
		MainPenal.setBorder(new MatteBorder(1, 0, 1, 0, (Color) new Color(0, 0, 0)));
		MainPenal.setBackground(new Color(238, 255, 238));
		MainPenal.setBounds(0, 85, 440, 130);
		add(MainPenal);
		...
		btnSingin.setBounds(81, 64, 285, 30);
		...
		btnSingUp.setBounds(81, 97, 141, 25);
		...
		btnGameExit.setBounds(226, 97, 141, 25);
